<VirtualHost *:80>
  ...
  DocumentRoot /home/carlo/public_html/glamor_mommy_demo/current/public
  <Directory /home/carlo/public_html/glamor_mommy_demo/current/public>
     AllowOverride all
     Options -MultiViews
  </Directory>
  ...
  # RewriteRule   ^(.*)$   http://glamormommy.com$1   [R=301,L]
  #
  # RewriteCond   %{HTTP_HOST}   ^([^.]*).securecellardoor.com$   [NC]
  # RewriteRule   ^(.*)$   http://%1.glamormommy.com$1   [R=301,L]
  ...
  ErrorLog  /home/carlo/public_html/glamor_mommy_demo/shared/log/error.log
  CustomLog /home/carlo/public_html/glamor_mommy_demo/shared/log/access.log combined
